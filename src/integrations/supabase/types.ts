  ...
  public: {
    Tables: {
      adm: {
        ...
        Relationships: [
          {
            foreignKeyName: "adm_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
      ...
      comentario_artigo: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "comentario_artigo_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
            referencedRelation: "usuario"
            referencedColumns: ["id_usuario"]
      ...
      comentario_projeto: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "comentario_projeto_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
            referencedRelation: "usuario"
            referencedColumns: ["id_usuario"]
      ...
      grupo: {
        ...
        Relationships: [
          {
            foreignKeyName: "grupo_criado_por_fkey"
            columns: ["criado_por"]
            isOneToOne: false
            referencedRelation: "usuario"
            referencedColumns: ["id_usuario"]
      ...
      grupo_membro: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "grupo_membro_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
            referencedRelation: "usuario"
            referencedColumns: ["id_usuario"]
      ...
      mensagem_grupo: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "mensagem_grupo_id_usuario_fkey"
            columns: ["id_usuario"]
            isOneToOne: false
            referencedRelation: "usuario"
            referencedColumns: ["id_usuario"]
